...
class Ui_tcpui(object):
    def setupUi(self, tcpui):
        ...
        self.server_ip = QLabel(self.layoutWidget)
        ...
        self.client_ip = QLabel(self.layoutWidget2)
        ...
        self.horizontalLayout_3.addWidget(self.client_ip)
        ...
        self.layoutWidget6 = QWidget(tcpui)
        self.layoutWidget6.setObjectName(u"layoutWidget6")
        self.layoutWidget6.setGeometry(QRect(10, 374, 321, 31))
        self.horizontalLayout_5 = QHBoxLayout(self.layoutWidget6)
        self.horizontalLayout_5.setObjectName(u"horizontalLayout_5")
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.fps_label = QLabel(self.layoutWidget6)
        ...
        self.image_size_label = QLabel(self.layoutWidget6)
        self.image_size_label.setObjectName(u"image_size_label")

        self.horizontalLayout_5.addWidget(self.image_size_label)

        self.open_button = QPushButton(tcpui)
        self.open_button.setObjectName(u"open_button")
        self.open_button.setGeometry(QRect(360, 380, 93, 28))
        self.close_button = QPushButton(tcpui)
        self.close_button.setObjectName(u"close_button")
        self.close_button.setGeometry(QRect(500, 380, 93, 28))
    ...
    def retranslateUi(self, tcpui):
        ...
        self.open_button.setText(QCoreApplication.translate("tcpui", u"\u5f00\u95e8", None))
        self.close_button.setText(QCoreApplication.translate("tcpui", u"\u4e0d\u5f00\u95e8", None))
    # retranslateUi
